<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Juego Favorito -->
        <div class="mt-4">
            <x-input-label for="juegoPreferido" :value="__('Juego preferido')" />
            <x-text-input id="juegoPreferido" class="block mt-1 w-full" type="text" name="juegoPreferido"
                :value="old('juegoPreferido')" required autofocus autocomplete="juegoPreferido" />
            <x-input-error :messages="$errors->get('juegoPreferido')" class="mt-2" />
        </div>
