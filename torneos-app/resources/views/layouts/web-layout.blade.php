...
<body class="bg-gray-200 p-4">
                    ...
                    <li class="block p-1 font-sans text-sm antialiased font-medium leading-normal text-blue-gray-900">
                        @auth
                            ...
                            <a href="{{ route('milogout') }}"
                                class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"> {{ __('Log Out') }}</a>
                        @else
                            <a href="{{ route('login') }}"
    ...
    <div
        class="block w-full max-w-screen-xl px-6 py-6 my-3 mx-auto text-white bg-white bg-opacity-80 backdrop-blur-2xl backdrop-saturate-200">
